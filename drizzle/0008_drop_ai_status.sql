...
INSERT INTO `__new_post`("id", "slug", "title", "summary", "category", "url", "url_key", "domain", "archive_url", "thumb_url", "problems", "facts", "author_id", "status", "submit_reason", "firsthand", "submitter_affiliated", "review_note", "reviewed_by", "comment_count", "vote_slop_count", "vote_ok_count", "is_demo", "published_at", "created_at", "updated_at", "deleted_at") SELECT "id", "slug", "title", "summary", "category", "url", "url_key", "domain", "archive_url", "thumb_url", "problems", "facts", "author_id", "status", "submit_reason", "firsthand", "submitter_affiliated", "review_note", "reviewed_by", "comment_count", "vote_slop_count", "vote_ok_count", "is_demo", "published_at", "created_at", "updated_at", "deleted_at" FROM `post`;--> statement-breakpoint
