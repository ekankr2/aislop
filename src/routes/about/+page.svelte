...
<Seo
  title="소개·원칙·정정"
  description="여기가 무엇을 모으고, 똥인지 된장인지를 누가 어떻게 정하는지, 정정을 어떻게 처리하는지."
/>
...
<!-- ⚠️ 여기에 정의를 다시 풀어 쓰지 마라. 한때 /ai-slop 첫 문단을 그대로 복사해
  ...
  <p class="text-ink-2">
    ...
    이 사이트에는 운영자가 찍는 도장이 없다. 똥인지 된장인지도, AI를 썼는지도
    운영자가 정하지 않는다. AI를 썼다는 근거는 글쓴이가 본문에 적고, 그게 맞는지와
    그래서 이게 똥인지 된장인지는 <a href="#투표">보는 사람들의 표</a>가 답한다.
  </p>
  ...
  <ol class="list-decimal space-y-1.5 pl-5 text-ink-2">
    ...
    <li>
      <b class="text-ink">똥인지 된장인지는 보는 사람들이 정한다.</b> 사례마다 투표하고
      결과를 그대로 보여준다.
    </li>
    <li>
  ...
  <p class="mt-3 text-ink-2">
    <b>운영자는 똥인지 된장인지를 정하지 않는다.</b> 하는 일은 사실 확인이다. AI를 썼는지
