...
export const AI_STATUS_HINT: Record<AiStatus, string> = {
  confirmed: "메타데이터·업체 확인·탐지 근거로 확인했습니다.",
  self_disclosed: "만든 쪽이 AI 사용을 스스로 밝혔습니다.",
  circumstantial: "정황은 있으나 단정할 근거가 아직 없습니다.",
  unknown: "확인하지 못했습니다.",
  not_ai: "확인해 보니 AI 생성물이 아니었습니다.",
};
...
export const VERDICT_HINT: Record<Verdict, string> = {
  unrated: "아직 판정하지 않았습니다.",
  slop: "만들 이유가 없었거나, AI 사용을 숨겨 사실과 다르게 제시했습니다.",
  low_quality: "품질은 낮지만 속이거나 해를 끼치지는 않습니다.",
  disputed: "근거가 엇갈려 판단을 보류했습니다.",
  not_slop: "확인해 보니 문제 없었습니다.",
  exemplary: "AI를 밝히고 제대로 쓴 사례입니다.",
};
...
export const CATEGORY_HINT: Record<Category, string> = {
  ...
  image:
    ...
    "메뉴판·숙소·상품 사진이 실물과 다릅니다. 받아 보면 색·크기·구성이 딴판입니다.",
  video:
    "같은 배경에 자막만 바꿔 하루 수십 개씩 올리는 쇼츠, 아동용 채널의 대량 생성 영상.",
  media:
    "검색 상위만 노린 의미 없는 블로그와 뉴스. 읽고 나면 남는 게 없습니다.",
  review: "써 보지 않고 쓴 체험담, 별점만 채우는 대량 생성 후기.",
  writing:
    "하루 만에 찍어낸 전자책과 소설. 목차는 그럴듯한데 본문이 같은 말을 돌립니다.",
  music:
    "가사도 목소리도 생성한 곡을 사람이 만든 것처럼 올려 스트리밍 수익을 챙깁니다.",
